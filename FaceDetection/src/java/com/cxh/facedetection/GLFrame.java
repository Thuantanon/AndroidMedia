...
public class GLFrame {
    ...
    public void initFrame(){
        ...
        iTextureSamplerHandle = GLES30.glGetUniformLocation(programId, "iTexture");
        aTextureCoordHandle = GLES30.glGetAttribLocation(programId, "aTexCoord");
        sHandle = GLES30.glGetUniformLocation(programId,"S");
        hHandle = GLES30.glGetUniformLocation(programId,"H");
        lHandle = GLES30.glGetUniformLocation(programId,"L");

        iHandle = GLES30.glGetUniformLocation(programId,"i");
        ...
        GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, vertexBuffers[1]);
        GLES30.glBufferData(GLES30.GL_ARRAY_BUFFER, textureVertexData.length*4, textureVertexBuffer, GLES30.GL_STATIC_DRAW);
    ...
    public void drawFrame(int tId,int textureId,float[] STMatrix){
        ...
        GLES30.glUniform1i(iTextureSamplerHandle,1);

        GLES30.glUniform1f(sHandle,s);
        GLES30.glUniform1f(hHandle,h);
        GLES30.glUniform1f(lHandle,l);
        GLES30.glUniform1f(iHandle,tId);
