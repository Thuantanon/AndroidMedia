 ...
 * Desc :
 */
public class TextureBlurFilter extends BaseGLBeautyFilter {
    ...
    public TextureBlurFilter(int width, int height) {
        super(width, height);

        String vertexShader = FileUtil.readShaderFromAssets("filter/blur/vertex_shader.glsl");
        String fragShader = FileUtil.readShaderFromAssets("filter/blur/fragment_shader.glsl");
