 ...
 * Desc :
 */
public class TextureNoseFilter extends BaseGLBeautyFilter {
    ...
    private float[] mNoseLeft;
    private float[] mNoseRight;
    private float[] mNoseCenter;

    public TextureNoseFilter(int width, int height) {
        super(width, height);

        String vertexShader = FileUtil.readShaderFromAssets("filter/nose/vertex_shader.glsl");
        String fragShader = FileUtil.readShaderFromAssets("filter/nose/fragment_shader.glsl");
    ...
    public int draw(int textureId, int width, int height) {
        ...
        OpenGLUtils.setUnifrom2fv(mProgramId, "mNoseLeft", mNoseLeft);
        OpenGLUtils.setUnifrom2fv(mProgramId, "mNoseRight", mNoseRight);
        OpenGLUtils.setUnifrom2fv(mProgramId, "mNoseCenter", mNoseCenter);
    ...
    public void setNose(float[] noseLeft, float[] noseRight, float[] noseCenter) {
        mNoseLeft = noseLeft;
        mNoseRight = noseRight;
        mNoseCenter = noseCenter;
    }
}
