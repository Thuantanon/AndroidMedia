 ...
 * Desc :
 */
public class TextureFaceFilter extends BaseGLBeautyFilter {
    ...
    public TextureFaceFilter(int width, int height) {
        super(width, height);

        String vertexShader = FileUtil.readShaderFromAssets("filter/face/vertex_shader.glsl");
        String fragShader = FileUtil.readShaderFromAssets("filter/face/fragment_shader.glsl");
    ...
    public int draw(int textureId, int width, int height) {
        ...
        OpenGLUtils.setUnifrom2fv(mProgramId, "mTop", mTop);
        OpenGLUtils.setUnifrom2fv(mProgramId, "mBottom", mBottom);
        OpenGLUtils.setUnifrom2fv(mProgramId, "mControlPoint", mControlPoint);
    ...
    public void setFace(float[] top, float[] bottom, float[] control) {
        mTop = top;
        mBottom = bottom;
        mControlPoint = control;
    }
}
