package com.cxh.androidmedia.render_old.filters;
 ...
 * Desc : 绘制纹理
 */
public class FilterGrayDrawable extends BaseDrawable {
    ...
    private short[] VERTEX_ARRAY = {
            0, 1, 2,
            0, 2, 3
    };

    private float[] TEXTURE_ARRAY = new float[]{
            0, 0,
            1f, 0,
            1f, 1f,
            0, 1f
