 ...
 * Desc : 之前还不知道FBO这玩意，天真的以为所有特效都写一个shader里^_^
 */
public class HighBeautyDrawable extends BaseDrawable {
    ...
    public HighBeautyDrawable() {
        ...
        String vertexCode = FileUtil.readShaderFromAssets(AMApp.get(), "glsl/render3/render_vertex.glsl");
        String fragmentCode = FileUtil.readShaderFromAssets(AMApp.get(), "glsl/render3/render_fragment.glsl");
        ...
        mImageTexture = OpenGLUtils.loadTexture(AMApp.get(), R.drawable.beauty);
    }
